...
//Write a function called reversedLooper that is given letters as it's only argument and loops through the given array backwards alerting every item in the array starting at the end.
  ...
  function reversedLooper(letters) {
    for (var y = letters.length-1; y >= 0; y--) {
      alert(letters[y]);
    }
  }
...
*/
  ...
  function removeItem(myGroceryList, item) {
    for (var y = 0; y < myGroceryList.length; y++) {
      if (myGroceryList[y] === item)
        myGroceryList.splice(y, 1);
    }
...
users.push({
  name: "Kaycee Ingram",
  email: "Kaycee@NoneYaBusiness.com",
  password: "JsIsAwesome",
  username: "Kwill33"
});
users.push({
  name: "William Ingram",
  email: "William@howdy.com",
  password: "TexasIsAwesome",
  username: "William33"
});
...
Once you find the particular index he's located in, delete him from the array.*/
  ...
  for (var y = 0; y < users.length; y++) {
    if (users[y]["email"] === "tylermcginnis33@gmail.com")
      users.splice(y, 1);
  }  
